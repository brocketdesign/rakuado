...
import {
  ...
  Briefcase, TrendingUp, LineChart, Wallet, PlusCircle, ShieldCheck, LifeBuoy, ExternalLink,
} from 'lucide-react'
  ...
  return (
    <div className="flex h-full flex-col bg-[#0f172a] border-r border-[#1e293b]">
      ...
      <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        {/* Rakubun external link */}
        <div className="mt-2 px-3">
          <a
            href={RAKUBUN_DASHBOARD_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-blue-400 hover:bg-blue-500/10 hover:text-blue-300 transition-all duration-200 border border-blue-500/20 hover:border-blue-500/40"
          >
